...
import ea.testexecutorlib import TestInteropLib as TestInteropLib

class Client(TestInteropLib.InteropPlugin):
    """
    Jira plugin
    """
    
    def __init__(self, parent, url, login, password, project, 
                       verifySsl=False, apiVersion="2", proxies={} ):
        """
        Jira interop
