...
from ea.sutadapters import HTTP as AdapterHTTP
from ea.sutadapters import DataExchange

from ea.sutadapters.REST import templates
...
class Client(TestAdapter.Adapter):
	...
	def __init__(self, parent, name=None, bindIp='', bindPort=0, destinationIp='127.0.0.1', destinationPort=80, debug=False,
		...
		self.LIB_JSON = DataExchange.JSON(parent=parent, name=name, debug=debug, ignoreErrors=True)
