...
class TESTCASE_SOCKS4_01(TestCase):
	...
	def prepare(self):
		...
		self.ADP_TCP = SutAdapters.TCP.Client(parent=self, bindIp='', bindPort=0, name=None, destinationIp=input('DEST'),
																	...
																	agent=input('AGENT'), shared=False)
