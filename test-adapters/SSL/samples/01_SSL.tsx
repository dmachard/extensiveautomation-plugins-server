...
class TESTCASE_01(TestCase):
	...
	def prepare(self):
		self.ADP_SSL = SutAdapters.SSL.Client(parent=self)
	...
	def definition(self):
		...
		if self.step1.isEnabled():
			...
			self.ADP_SSL.initSocketSsl(sock=socket)
...
<testdevelopment>1561319409.07098</testdevelopment>
</file>