...
class TESTCASE_01(TestCase):
	...
	def prepare(self):
		self.CISCO = SutAdapters.Cisco.Catalyst(parent=self, destIp="127.0.0.1")
	...
	def definition(self):
		...
		if self.step1.isEnabled():
			...
			self.CISCO.enable(password="ok", timeout=input('TIMEOUT'))
			
			self.CISCO.config(timeout=input('TIMEOUT'))
...
<testdevelopment>1561317992.6921911</testdevelopment>
</file>