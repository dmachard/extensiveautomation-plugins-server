...
class MYSQL_01(TestCase):
	...
	def prepare(self):
		...
		self.ADP_MYSQL = SutAdapters.Database.MySQL( parent=self, host=input('HOST_DST'), user=input('MYSQL_LOGIN'),
													...
													agent=input('AGENT_DB'), agentSupport=input('SUPPORT_AGENT')
											)
